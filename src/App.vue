...
<template>
	...
	<div v-if="this.workouts">
		<div
			v-if="state === null"
			class="hero card shadow-2xl bg-base-100"
		>
			<div class="hero-content flex-col">
				<div class="text-center">
					<h1 class="text-5xl font-bold">Weightlifting App</h1>
					<p class="py-6">
						Add a new workout or select one from the list below to view details.
					</p>
				</div>
				<div>
					<div class="card-body">
						<div
							v-for="(workout, index) in this.workouts"
							:key="workout.id"
							class="m-2"
						>
							<Workout
								@click="handleWorkoutClick(index)"
								v-bind:workoutObj="workout"
							/>
						</div>
					</div>
					<div class="form-control">
						<button
							@click="this.state = 'add'"
	...
	<div
		v-if="state === 'workout'"
		class="rounded-md hero bg-base-200"
	>
		<div class="hero-content text-center">
			<div>
				<h1 class="text-5xl font-bold">
					{{ this.workouts[this.selected].title }}
				</h1>
				...
				<div class="overflow-x-auto">
					<table class="table w-full">
						...
						<tbody
							v-for="(exercise, index) in this.workouts[this.selected]
								.exercises"
							:key="exercise.id"
						>
							<tr>
